...
module.exports = {
    ...
    startGame: async (botEnabled) => {
        ...
        return axios.post(startGameUrl, reqBody, util.defaultHeaders)
            .then((res) => {
                return res.data;
            })
            .catch((error) => {
    ...
    joinGame: (gameId) => {
        ...
        return axios.post(url, reqBody, util.defaultHeaders)
            .then((res) => {
                currBoard = res.data
                return (res.data)
            })
    ...
    makeMove: (gameId, position, token) => {
        ...
        return axios.post(url, body, {headers: reqHeader})
            .then((res) => {
                currBoard = res.data
                return currBoard;
            })
    ...
    randStrategy: () => {
        ...
        let letter = util.mapToCoordinates((Math.floor(Math.random() * 10)).toString());
